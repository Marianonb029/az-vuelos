...
- `packages/scraper` — Playwright + un adaptador por aerolínea en `src/adapters/`
- `data` — catálogos IATA (JSON generado, no editar a mano)
...
5. El precio sale del sitio oficial de la aerolínea, no de agregadores ni OTAs.
