...
const dia = (fecha: string, presion: number): PuntajeDia => ({ fecha, aeropuerto: "EZE", presion, etiquetas: [], banda: presion <= 33 ? "verde" : presion <= 66 ? "amarillo" : "rojo", fundamento: "", senales: [], revisado: [] });
