...
export { competenciaCorredorDe, competenciaEfectivaDe, factorCompetencia, factorPorDias, kmEquivalentes, medirRuta } from "./fase7-indice";
export type { ConfigFase7, EntradaFase7, MedidaRuta } from "./fase7-indice";
export { priorizarConDetalle, priorizarRutas } from "./fase7-ranking";
export type { ResultadoPriorizacion } from "./fase7-ranking";
export { dondeBuscar, explicarRuta } from "./fase7-explicacion";
export type { ContextoExplicacion, DondeBuscar, ExplicacionRuta } from "./fase7-explicacion";
