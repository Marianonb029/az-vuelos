...
| Iberia (IB) | Su API de reservas (`ibisauth.iberia.com`) respondió **HTTP 403** a todas las sesiones automatizadas durante el desarrollo. El adaptador navega, detecta el rechazo y lo reporta como `bloqueado` con evidencia. No tiene lector de resultados porque nunca se pudo observar una página de resultados. |
