...
| **Combinaciones** | *¿Qué rutas existen, aunque no tengan precio?* Origen y destino (aeropuerto o continente) → todas las rutas que el grafo de aerolíneas permite desde el origen y sus alternativos, en un boleto o dos por un hub, sin fecha ni precio: itinerario, quién vende cada boleto, quién opera cada tramo, km, frecuencia y si el par ya tiene tarifas en el mercado. Plegado por salida y destino, con filtro. Para buscar alternativas a mano. |
