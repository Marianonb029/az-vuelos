...
const GLOSARIO: { termino: string; significado: string; sale: string }[] = [
  ...
  { termino: "Bajada por continentes", significado: "pnpm precios recorre los aeropuertos de salida de cada grupo de prioridad (1. América → Europa, 2. Europa → América, 3. Europa → Asia, 4. América → Asia), los de más salidas primero: un pedido sin destino descubre a qué destinos hay cache y un pedido por par trae el mínimo de cada fecha. Con presupuesto por corrida; la siguiente sigue donde quedó.", sale: "Precios cacheados (Travelpayouts)" },
