...
describe("Búsqueda en vivo de un par (Fase 18)", () => {
  ...
  it("si el API no responde durante la vigilancia, avisa y reintenta al minuto en vez de abortar", async () => {
    ...
    render(<EnVivo origen="ASU" destino="FRA" fechaIda="2027-01-19" flexDias={0} marker={null} disponible segundosPorBusqueda={45} hoy="2026-09-19" onActualizado={onActualizado} />);
    await act(async () => {
